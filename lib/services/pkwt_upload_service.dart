...
class PkwtUploadService {
  ...
  /// Upload PKWT PDF to Firebase Storage
  Future<PkwtDocument> uploadPkwtPdf({
    ...
    try {
      ...
      // Storage path: users/{userId}/employees/{employeeId}/pkwt/{fileName}
      final storageRef = _storage.ref().child('users/$userId/employees/$employeeId/pkwt/$fileName');
      ...
      // Create PkwtDocument object
      final pkwtDocument = PkwtDocument(
