...
class EvaluationUploadDialog extends StatefulWidget {
  ...
  @override
  State<EvaluationUploadDialog> createState() => _EvaluationUploadDialogState();

  static Future<void> show(BuildContext context, String employeeId) {
    return showDialog(
      context: context,
      barrierDismissible: false,
      builder: (context) => EvaluationUploadDialog(employeeId: employeeId),
    );
  }
}

class _EvaluationUploadDialogState extends State<EvaluationUploadDialog> {
    ...
    try {
      ...
      if (mounted) {
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Evaluasi berhasil diupload!'),
